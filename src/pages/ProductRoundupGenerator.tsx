    ...
    <div className="flex min-h-screen bg-background">
      ...
      <main className="flex-1 overflow-y-auto">
        <div className="container mx-auto p-8 max-w-7xl">
          <div className="mb-8">
            <h1 className="text-4xl font-bold mb-2">Product Roundup Generator</h1>
            <p className="text-muted-foreground">Create comprehensive "Best of" product roundups with detailed comparisons</p>
          </div>
